...
- [knock_frequency.md](knock_frequency.md) — bore → knock band; the `900` constant; Bessel-root modes (1.66×/2.08×, not integer harmonics); fuel/CR/humidity/water-injection sensitivity (all sub-band)
