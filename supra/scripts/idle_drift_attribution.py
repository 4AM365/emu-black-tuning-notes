...
LOG = "supra/logs/new_fuel_strategy.csv"
HOT_CLT = 95.0
...
fig.suptitle("Hot-idle drift attribution — new_fuel_strategy", fontsize=13)
fig.tight_layout(rect=[0, 0, 1, 0.97])
fig.savefig("supra/scripts/idle_drift_attribution.png", dpi=130)
print("\nplot -> supra/scripts/idle_drift_attribution.png")
